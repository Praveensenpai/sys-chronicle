...
pub fn generate_ai_report(events: &[ActivityEvent], title_date: &str) -> String {
    ...
    if !cpu_samples.is_empty() {
        ...
        let avg_ram: f32 =
            ram_samples.iter().map(|(_, _, p)| p).sum::<f32>() / ram_samples.len() as f32;
